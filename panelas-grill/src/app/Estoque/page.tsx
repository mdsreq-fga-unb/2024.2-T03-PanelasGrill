    ...
    const [showInput, setShowInput] = useState(false);
        ...
        const estoqueFiltrado = estoque.filter((item) => {
            const matchesSearch = item.item.toLowerCase().includes(searchValue.toLowerCase());
            const matchesTipo = tipoFiltro ? item.tipo === tipoFiltro : true;
                ...
                <div className="flex-1 bg-white flex flex-col pl-72 ml-3">
                    ...
                    <main className="flex-1 p-6 bg-primary-gray text-black ">
                        ...
                        <div className="flex items-center space-x-4 mb-4">
                            <h3 className="text-xl">Filtre por tipo:</h3>
                            <select
                                value={tipoFiltro}
                        ...
                        <table className="table-auto bg-white border border-gray-300 rounded-lg w-full">
                            <thead>
